...
def hospital():
    selected_category = st.sidebar.selectbox("Select an option", list(hospital_record['Description']))
    selected_item = hospital_record.loc[hospital_record['Description'] == selected_category, 'Item Code'].iloc[0]
